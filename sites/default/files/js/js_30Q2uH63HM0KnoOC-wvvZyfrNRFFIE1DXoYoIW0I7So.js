...
(function ($, Drupal) {
    ...
    Drupal.behaviors.expansion_panel = {
        attach: function (context, settings) {
            ...
            function resizeInput(element) {
                ...
                if(value) {
                    var appendText = '<span class="mdl-expansion__header mdc-typography--body1">' + label + ': ' + value + '</span>';
                    $('.mdl-expansion__summary').append(appendText);
                    // console.log(appendText);
                }
            }

            $('.mdl-expansion .mdc-form-field').each(function(){
                var _this = $(this);
                resizeInput(_this);
            });
...
(function ($, Drupal) {
  ...
  Drupal.tableSelect = function () {
    ...
    $table.find('th.select-all').prepend($('<div class="mdc-form-field">' +
        '<div id="mdc-js-checkbox" class="mdc-checkbox">' +
        '<input type="checkbox" id="native-js-checkbox" class="mdc-checkbox__native-control">' +
        ...
        '</div>' +
        '</div>' +
    '</div>').attr('title', strings.selectAll)).on('click', function (event) {
